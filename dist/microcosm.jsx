...
const LEVEL_ROWS = [
  {
    ...
    "briefing": "Twenty founders of Solara drift onto a settling ground under a weak sun. Left alone, the mat barely grows — a few dozen, far below what this ground could carry. Light is this world's only income. Your instrument is the sun: grip it in Intervene mode and raise its light.",
    ...
    "predict": {
      ...
      "options": [
        ...
        "It barely grows — a few dozen, no more",
        "It grows until the water's mineral runs out"
      ],
      "reflect": [
        "Slowly, yes — but never there. Under this sun the mat crept to a few dozen and stopped, a long way from 400.",
        "That's what the census showed: a few dozen Solara, and no more. Light sets the ceiling here.",
        "The water never got to matter. This sun carried a few dozen Solara, and the mineral was still there."
      ]
    },
    "world": {
      "seed": 101,
    ...
    "failNow": [
      {
        ...
        "why": "The last Solara died. What it needed was light — warmth only made it spend faster."
      }
    ],
    "timeoutWhy": "The mat stayed below 400. This sun carries a few dozen Solara — no more, however long you wait.",
    "meter": [
      {
        "label": "Solara",
        "m": "pop",
    ...
    "debrief": {
      "pass": "Light is the pond's only income. Under the dim sun the mat crept to a few dozen and stopped — that was all the light could carry. With more light it grew fast, then flattened: the mat shades itself and runs out of ground. That ceiling is the carrying capacity — not a quota, just income meeting cost. Move the light, and the ceiling moves with it.",
      "fail": "The mat needed more income, and only light is income here. Tap a Solara and watch its card: the energy bar barely fills. Grip the sun and push its light all the way up — early. Everything else in the sky just moves the cost around."
    }
  },
  {
    "key": "mineral",
    ...
    "question": "The sun is already at its fiercest — why does the mat stop short anyway?",
    "briefing": "The sun starts pinned at its maximum — no more light to be had — but the water is poor. The mat rises, then slows to a crawl; light has nothing left to give. You carry ten doses of mineral: tap open water to pour one, and choose the spot with care.",
  ...
  },
  {
    ...
    "briefing": "Poor water, and the quick plankton owns it: Drifta drinks faster, and the meadow barely grows under a bright sun. You carry eight doses of mineral, and the seeding bench is open. Choose your instrument.",
  ...
  },
  {
    ...
    "briefing": "A bloom, a mat, decomposers — and nobody eating anybody. Mineral is unlimited this time, and the seeding bench is open. The goal is a richer pond: a meadow past 1,250 and at least 20 Cilio, held. Decide what this pond is actually missing.",
    "goalText": "A richer pond — 1,250 Solara, 20 Cilio, held",
    "predict": {
...
function ResetButton({ onReset, lift }){
  ...
  return (
    <button aria-label="Reset world"
      ...
      style={{ position:"absolute", right:16, zIndex:6,
        bottom: lift ? lift : "calc(env(safe-area-inset-bottom, 0px) + 84px)",
...
// ============================================================
const LEVEL_THUMBS = {
  "light": "data:image/jpeg;base64,",
  "mineral": "data:image/jpeg;base64,",
  "cycle": "data:image/jpeg;base64,",
  "garden": "data:image/jpeg;base64,",
  "richer": "data:image/jpeg;base64,",
  "hunters": "data:image/jpeg;base64,",
  "outpost": "data:image/jpeg;base64,",
  "warmyear": "data:image/jpeg;base64,",
  "sorting": "data:image/jpeg;base64,",
  "refuge": "data:image/jpeg;base64,",
  "outrun": "data:image/jpeg;base64,",
};
// ============================================================
